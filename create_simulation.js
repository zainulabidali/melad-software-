...
// We will read calculateResultData from firebase.js
const firebaseCode = fs.readFileSync('js/firebase.js', 'utf8');

// Extract just the calculateResultData function and its helpers
...
fs.writeFileSync('simulate_test.js', script);
